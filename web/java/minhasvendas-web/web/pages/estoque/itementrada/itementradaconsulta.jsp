		...
		<div class="portlet box blue-hoki">
			...
			<div class="portlet-body">
				<div class="row">
					...
					<div class="col-sm-2">
						<select id="ParametroPesquisa" class="form-control input-circle">
							<option value="idItemEntrada">idItemEntrada</option>
				...
				<div class="table-scrollable">
					<div class="portlet">
						<div class="portlet-body">
							<div class="DataGridConsulta" data-page="itementradaconsulta.grid.action" data-page-size="8" data-detail-page="itementradacadastro.action"></div>
						</div>
					</div>
				</div>
